 ...
 * Furthermore you are able to define a condition. If you do so, the method will
 * only be executed if this condition returns the boolean value true.<br>
...
public class MoveExecuteMethodAdapter extends MovementHandler {
	...
	protected MoveExecuteMethodAdapter(Object objectForInvocation,
			Method methodToInvoke, Object[] methodParameter) {
	 ...
	 */
	public static MovementHandler $(Object objectForInvocation,
			Method methodToInvoke, Object... methodParameter) {
		return new MoveExecuteMethodAdapter(objectForInvocation,
				methodToInvoke, methodParameter);
	}

	/**
	 * Define a condition. If you do so, the main method will only be invoked if
	 * this condition (invocation) returns the boolean value true.<br>
	 * 
	 * @param objectForInvocation
	 *            If the method is static, this argument should be null.
	 * @param methodToInvoke
	 * @param methodParameter
	 */
	public void setCondition(Object objectForInvocation, Method methodToInvoke,
	...
	public void tryMove(Movable movable, float deltaTime) {
		try {
			if (methodToInvokeCondition == null) {
				...
				Object result = methodToInvokeCondition.invoke(
						objectForConditionInvocation, methodParameterCondition);
